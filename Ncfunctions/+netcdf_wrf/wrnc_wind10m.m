function rtn = wrnc_wind10m(NC, Lon, Lat, time, U10, V10, options)
    ...
    switch Method
        case 'LowLevel'
            ...
            netcdf.defVarFill(ncid, U10_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
            netcdf.defVarFill(ncid, V10_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
        ...
        case 'HighLevel'
            ...
            ncwriteatt(ncname, '/', 'WriteProgram', sprintf('netcdf_wrf:%s_V%s', mfilename, Version));
