    ...
    switch Method
        case 'LowLevel'
            ...
            if SWITCH.current
                ...
                netcdf.defVarFill(ncid, u_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
                netcdf.defVarFill(ncid, v_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
            ...
            if SWITCH.zeta
                ...
                netcdf.defVarFill(ncid, h_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
            ...
            netcdf.putAtt(ncid, netcdf.getConstant('NC_GLOBAL'), 'WriteProgram', ['netcdf_tpxo:', mfilename, ' V', Version]); % 写入程序信息
        ...
        case 'HighLevel'
            ...
            ncwriteatt(ncname, '/', 'WriteProgram', ['netcdf_tpxo:', mfilename, ' V', Version]);
            ncwriteatt(ncname, '/', 'start', GA_start_date);
