    ...
    switch Method
        case 'LowLevel'
            ...
            if SWITCH.current
                ...
                netcdf.defVarFill(ncid, u_id, false, realmax('single')); % 设置缺省值
                netcdf.defVarFill(ncid, v_id, false, realmax('single')); % 设置缺省值
            ...
            if SWITCH.zeta
                ...
                netcdf.defVarFill(ncid, h_id, false, realmax('single')); % 设置缺省值
