function wrnc_temp(ncid,Lon,Lat,Delement,time,Velement,GA_start_date,varargin)
    ...
    if SWITCH.sgm
        ...
        netcdf.putAtt(ncid,temp_sgm_id, 'units',        'Celsius');                                 % u_sgm
        netcdf.putAtt(ncid,temp_sgm_id, 'long_name',    'sea water temperature at sigma levels');             % u_sgm
        netcdf.putAtt(ncid,temp_sgm_id, 'coordinates',  'sigma_levels');                     % u_sgm
    end
