function rtn = wrnc_sand_nemuro(NC,Lon,Lat,Delement,time,Velement,varargin)
    ...
    case 'LowLevel'
        ...
        if SWITCH.std
            ...
            netcdf.defVarFill(ncid, sand_std_id, false, realmax('single'));  % 设置缺省值
        ...
        if SWITCH.sgm
            ...
            netcdf.defVarFill(ncid, sand_sgm_id, false, realmax('single'));  % 设置缺省值
        ...
        if SWITCH.avg
            ...
            netcdf.defVarFill(ncid, sand_avg_id, false,  realmax('single')); % 设置缺省值
