function rtn = wrnc_ph_ersem(NC,Lon,Lat,Delement,time,Velement,varargin)
    ...
    case 'LowLevel'
        ...
        if SWITCH.std
            ...
            netcdf.defVarFill(ncid, ph_std_id, false, realmax('single'));  % 设置缺省值
        ...
        if SWITCH.sgm
            ...
            netcdf.defVarFill(ncid, ph_sgm_id, false, realmax('single'));  % 设置缺省值
        ...
        if SWITCH.avg
            ...
            netcdf.defVarFill(ncid, ph_avg_id, false,  realmax('single')); % 设置缺省值
