function rtn = wrnc_zp_nemuro(NC,Lon,Lat,Delement,time,Velement,varargin)
    ...
    case 'LowLevel'
        ...
        if SWITCH.std
            ...
            netcdf.defVarFill(ncid, zp_std_id, false, realmax('single'));  % 设置缺省值
        ...
        if SWITCH.sgm
            ...
            netcdf.defVarFill(ncid, zp_sgm_id, false, realmax('single'));  % 设置缺省值
        ...
        if SWITCH.avg
            ...
            netcdf.defVarFill(ncid, zp_avg_id, false,  realmax('single')); % 设置缺省值
