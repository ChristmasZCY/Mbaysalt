function rtn = wrnc_zp_nemuro(NC, Lon, Lat, Delement, time, Velement, varargin)
    ...
    %       netcdf_fvcom.wrnc_zp_nemuro('zp.nc',Lon,Lat,Delement,time,Velement)
    %       netcdf_fvcom.wrnc_zp_nemuro('zp.nc',Lon,Lat,Delement,time,Velement,'conf',conf)
    %       netcdf_fvcom.wrnc_zp_nemuro('zp.nc',Lon,Lat,Delement,time,Velement,'conf',conf,'INFO')
    %       netcdf_fvcom.wrnc_zp_nemuro('zp.nc',Lon,Lat,Delement,time,Velement,'conf',conf,'INFO','Text_len',45)
    %       netcdf_fvcom.wrnc_zp_nemuro('zp.nc',Lon,Lat,Delement,time,Velement,'dtype','int16')
    % =================================================================================================================
    ...
    switch Method
        case 'LowLevel'
            ...
            if SWITCH.std
                ...
                netcdf.defVarFill(ncid, zp_std_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
            ...
            if SWITCH.sgm
                ...
                netcdf.defVarFill(ncid, zp_sgm_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
            ...
            if SWITCH.avg
                ...
                netcdf.defVarFill(ncid, zp_avg_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
            ...
            if SWITCH.std
                ...
                % ATTRS.zp_std.key = ATTRS.zp_std.value; % Zp_std
                for key = fieldnames(ATTRS.zp_std)'
                    netcdf.putAtt(ncid, zp_std_id, key{1}, ATTRS.zp_std.(key{1}));
                end % Zp_std
            ...
            if SWITCH.sgm
                ...
                % ATTRS.zp_sgm.key = ATTRS.zp_sgm.value; % Zp_sgm
                for key = fieldnames(ATTRS.zp_sgm)'
                    netcdf.putAtt(ncid, zp_sgm_id, key{1}, ATTRS.zp_sgm.(key{1}));
                end % Zp_sgm
            ...
            if SWITCH.avg
                ...
                % ATTRS.zp_avg.key = ATTRS.zp_avg.value; % Zp_avg
                for key = fieldnames(ATTRS.zp_avg)'
                    netcdf.putAtt(ncid, zp_avg_id, key{1}, ATTRS.zp_avg.(key{1}));
                end % Zp_avg
        ...
        case 'HighLevel'
            ...
            if SWITCH.std
                ...
                [scale_factor, add_offset] = calc_scale_offset(Zp_std, dtype);
                nccreate(ncname, 'ZP_std', ...
                ...
                for key = fieldnames(ATTRS.zp_std)'
                    ncwriteatt(ncname, 'ZP_std', key{1}, ATTRS.zp_std.(key{1}));
                end

                ncwriteatt(ncname, 'ZP_std', 'scale_factor', scale_factor);
                ncwriteatt(ncname, 'ZP_std', 'add_offset', add_offset);
                ncwrite(ncname, 'ZP_std', Zp_std);
            end
            ...
            if SWITCH.sgm
                ...
                [scale_factor, add_offset] = calc_scale_offset(Zp_sgm, dtype);
                nccreate(ncname, 'ZP_sgm', ...
                ...
                for key = fieldnames(ATTRS.zp_sgm)'
                    ncwriteatt(ncname, 'ZP_sgm', key{1}, ATTRS.zp_sgm.(key{1}));
                end

                ncwriteatt(ncname, 'ZP_sgm', 'scale_factor', scale_factor);
                ncwriteatt(ncname, 'ZP_sgm', 'add_offset', add_offset);
                ncwrite(ncname, 'ZP_sgm', Zp_sgm, [1, 1, 1, 1]);
            end
            ...
            if SWITCH.avg
                ...
                [scale_factor, add_offset] = calc_scale_offset(Zp_avg, dtype);
                nccreate(ncname, 'ZP_avg', ...
                ...
                for key = fieldnames(ATTRS.zp_avg)'
                    ncwriteatt(ncname, 'ZP_avg', key{1}, ATTRS.zp_avg.(key{1}));
                end

                ncwriteatt(ncname, 'ZP_avg', 'scale_factor', scale_factor);
                ncwriteatt(ncname, 'ZP_avg', 'add_offset', add_offset);
