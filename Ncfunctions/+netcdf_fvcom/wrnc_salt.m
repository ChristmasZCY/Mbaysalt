    ...
    switch Method
        case 'LowLevel'
            ...
            if SWITCH.std
                ...
                netcdf.defVarFill(ncid, salt_std_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
            ...
            if SWITCH.sgm
                ...
                netcdf.defVarFill(ncid, salt_sgm_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
            ...
            if SWITCH.avg
                ...
                netcdf.defVarFill(ncid, salt_avg_id, false, calc_fillvalue('NC_FLOAT', 'LowLevel')); % 设置缺省值
