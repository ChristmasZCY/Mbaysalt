    ...
    switch Method
        case 'LowLevel'
            ...
            if SWITCH.std
                ...
                netcdf.defVarFill(ncid, pp_std_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
            ...
            if SWITCH.sgm
                ...
                netcdf.defVarFill(ncid, pp_sgm_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
            ...
            if SWITCH.avg
                ...
                netcdf.defVarFill(ncid, pp_avg_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
