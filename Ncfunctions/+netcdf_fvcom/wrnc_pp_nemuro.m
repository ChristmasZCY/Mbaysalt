function rtn = wrnc_pp_nemuro(NC,Lon,Lat,Delement,time,Velement,varargin)
    ...
    case 'LowLevel'
        ...
        if SWITCH.std
            ...
            netcdf.defVarFill(ncid, pp_std_id, false, realmax('single'));  % 设置缺省值
        ...
        if SWITCH.sgm
            ...
            netcdf.defVarFill(ncid, pp_sgm_id, false, realmax('single'));  % 设置缺省值
        ...
        if SWITCH.avg
            ...
            netcdf.defVarFill(ncid, pp_avg_id, false,  realmax('single')); % 设置缺省值
