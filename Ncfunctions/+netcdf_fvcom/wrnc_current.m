    ...
    case 'LowLevel'
        ...
        if SWITCH.std
            ...
            if SWITCH.u
                ...
                netcdf.defVarFill(ncid, u_std_id, false, realmax('single')); % 设置缺省值
            ...
            if SWITCH.v
                ...
                netcdf.defVarFill(ncid, v_std_id, false, realmax('single')); % 设置缺省值
            ...
            if SWITCH.w
                ...
                netcdf.defVarFill(ncid, w_std_id, false, realmax('single')); % 设置缺省值
        ...
        if SWITCH.sgm
            ...
            if SWITCH.u
                ...
                netcdf.defVarFill(ncid, u_sgm_id, false, realmax('single')); % 设置缺省值
            ...
            if SWITCH.v
                ...
                netcdf.defVarFill(ncid, v_sgm_id, false, realmax('single')); % 设置缺省值
            ...
            if SWITCH.w
                ...
                netcdf.defVarFill(ncid, w_sgm_id, false, realmax('single')); % 设置缺省值
        ...
        if SWITCH.avg
            ...
            if SWITCH.u
                ...
                netcdf.defVarFill(ncid, u_avg_id, false, realmax('single')); % 设置缺省值
            ...
            if SWITCH.v
                ...
                netcdf.defVarFill(ncid, v_avg_id, false, realmax('single')); % 设置缺省值
            ...
            if SWITCH.w
                ...
                netcdf.defVarFill(ncid, w_avg_id, false, realmax('single')); % 设置缺省值
        ...
        if SWITCH.ua
            ...
            netcdf.defVarFill(ncid, ua_id, false, realmax('single')); % 设置缺省值
            netcdf.defVarDeflate(ncid, ua_id, true, true, 5)
            Ua = Velement.Ua;
        end
        if SWITCH.va
            va_id = netcdf.defVar(ncid, 'va', 'NC_FLOAT', [londimID, latdimID, timedimID]); % va
            netcdf.defVarFill(ncid, va_id, false,  realmax('single')); % 设置缺省值
