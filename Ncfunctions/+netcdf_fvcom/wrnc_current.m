        ...
        case 'LowLevel'
            ...
            if SWITCH.std
                ...
                if SWITCH.u
                    ...
                    netcdf.defVarFill(ncid, u_std_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
                ...
                if SWITCH.v
                    ...
                    netcdf.defVarFill(ncid, v_std_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
                ...
                if SWITCH.w
                    ...
                    netcdf.defVarFill(ncid, w_std_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
            ...
            if SWITCH.sgm
                ...
                if SWITCH.u
                    ...
                    netcdf.defVarFill(ncid, u_sgm_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
                ...
                if SWITCH.v
                    ...
                    netcdf.defVarFill(ncid, v_sgm_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
                ...
                if SWITCH.w
                    ...
                    netcdf.defVarFill(ncid, w_sgm_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
            ...
            if SWITCH.avg
                ...
                if SWITCH.u
                    ...
                    netcdf.defVarFill(ncid, u_avg_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
                ...
                if SWITCH.v
                    ...
                    netcdf.defVarFill(ncid, v_avg_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
                ...
                if SWITCH.w
                    ...
                    netcdf.defVarFill(ncid, w_avg_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
            ...
            if SWITCH.ua
                ...
                netcdf.defVarFill(ncid, ua_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
            ...
            if SWITCH.va
                ...
                netcdf.defVarFill(ncid, va_id, false, calc_fillvalue('NC_FLOAT')); % 设置缺省值
