function rtn = wrnc_pco2_ersem(NC,Lon,Lat,Delement,time,Velement,varargin)
    ...
    case 'LowLevel'
        ...
        if SWITCH.std
            ...
            netcdf.defVarFill(ncid, pco2_std_id, false, realmax('single')); % 设置缺省值
        ...
        if SWITCH.sgm
            ...
            netcdf.defVarFill(ncid, pco2_sgm_id, false, realmax('single')); % 设置缺省值
        ...
        if SWITCH.avg
            ...
            netcdf.defVarFill(ncid, pco2_avg_id, false, realmax('single')); % 设置缺省值
