function wrnc_no3(ncid,Lon,Lat,Depth,time,No3,GA_start_date)
    ...
    %       No3:             NO3                     || required: True || type: double || format: matrix
    ...
    warning('Mbaysalt:DeprecationWarning: \n%s \n%s \n%s', ...
        ...
        '       See NETCDF_FVCOM.WRNC_NO3_ERSEM instead');
    ...
    netcdf.defVarFill(ncid,      no3_id,        false,      realmax('single')); % 设置缺省值
    ...
    netcdf.putAtt(ncid,no3_id, 'units',        'umolN/L');                            % NO3
    netcdf.putAtt(ncid,no3_id, 'long_name',    'NO3');                                % NO3
