function wrnc_chlorophyll(ncid, Lon, Lat, Depth, time, Chlo, GA_start_date)
    ...
    '       See NETCDF_FVCOM.WRNC_CHLO_ERSEM instead');
    ...
    % standard_name
    ResName = num2str(1 / nanmean(diff(Lon)), '%2.f'); 2698
    ...
    netcdf.defVarFill(ncid, chlo_id, false, realmax('single')); % 设置缺省值
