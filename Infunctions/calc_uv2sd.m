function [spd, dir] = calc_uv2sd(u ,v, opt)
    ...
    %       风：
    %           spd = sqrt(u^2+v^2);
    %           dir = atan2(u,v)/pi*180+180;  风的来向，北是0，东是90
    %       浪：北是0，东是90
    %           dir = 90;  % 风浪的来向
    %           U = sin(deg2rad(x+180)); % U 表示风浪的去向 (U,V)=(1,0)表示风从西往东吹，浪从西往东流
    %           V = cos(deg2rad(x+180)); % V 表示风浪的去向 (U,V)=(1,0)表示风从西往东吹，浪从西往东流
    %           U,V 的正向与坐标轴正向相同
    %           dir2 = rad2deg(atan2(U,V))+180; % dir2表示风浪的来向，与x相同
    % =================================================================================================================
