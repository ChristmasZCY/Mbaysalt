function Pic_draw_swh(varargin)
    % =================================================================================================================
    % discription:
    %       draw picture of swh and mwd from netcdf file
    ...
    for k=0:(DAY_LENGTH-1)
        ...
        for hour = 1:length(time)
            ...
            m_contourf(lon,lat,swh',levels,'linestyle','none'); %绘制等高线
            hold on;
            ...
            title("South China Sea Significant Wave Height   Unit: meter "+...
                    newline + ...
            ...
            txt=[folder_name,'/P_southchinasea_swh_level_1@',time_name,'.png'];
