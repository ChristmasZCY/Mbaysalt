...
# -*- coding: utf-8 -*-
"""
Usage: gluemncbig [-2] [-q] [--verbose] [--many] [-v <vars>] -o <outfile> <files>
...
if __name__ == '__main__':
    ...
    try:
        optlist, fnames = getopt(sys.argv[1:], '2qo:v:', ['many', 'verbose'])
        ...
        if manytiles:
            ...
            for fname in files0[1:]:
                try:
                    ...
                    if e.errno == errno.EMFILE:
                        sys.exit(
                            'ERROR: Too many open files.  Try again with --many or increase the limit on open files.')
                    raise
                ncs.append(nc)
