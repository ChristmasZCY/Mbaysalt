function create_fvcom_nscs_met(f2dm, din_forcing, fout, ymd_start, ymd_end)
    %       Create met forcing file for FVCOM_NSCS, data from WRF2FVCOM
    % =================================================================================================================
    % Parameters:
    %       f2dm: model 2dm grid file       || required: True || type: text    || example: 'nscs.2dm'
    %       din_forcing: forcing dir        || required: True || type: text    || example: './forcing/global'
    %       fout: file output               || required: True || type: text    || example: './fvcom_nscs_met_forecast/fvcom_nscs_met_20230722.nc'
    ...
    % =================================================================================================================
    % Example:
    %       create_fvcom_nscs_met('nscs.2dm','./forcing/global','./fvcom_nscs_met_forecast/fvcom_nscs_met_20230722.nc',20241105,20241106)
    % =================================================================================================================
