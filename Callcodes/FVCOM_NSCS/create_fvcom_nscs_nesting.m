function create_fvcom_nscs_nesting(fnest_nc, din_glory, din_tide, fout, yyyymmdd, day_len)
    %       Create nesting file for FVCOM_NSCS, data from glory and tpxo
    % =================================================================================================================
    % Parameters:
    %       fnest_nc: nesting example file      || required: True || type: text    || example: 'nesting.nc'
    ...
    %       fout: file output                   || required: True || type: text    || example: './fvcom_nscs_nesting_forecast/fvcom_nscs_nesting_20241101.nc'
    ...
    % =================================================================================================================
    % Example:
    %       create_fvcom_nscs_nesting('./data/nestnode_nscs.nc', '../Data/GLORYS', './data/NSCS_tide', './fvcom_nscs_nesting_forecast/fvcom_nscs_nesting_20241101.nc', 20241105, 1)
    % =================================================================================================================
    ...
    weight_2d.nele = interp_2d_calc_weight("ID",lon,lat,fn.xc,fn.yc);
    weight_2d.node = interp_2d_calc_weight("ID",lon,lat,fn.x,fn.y);
