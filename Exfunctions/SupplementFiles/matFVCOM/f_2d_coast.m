...
%
% Updates:
%       2024-05-15: xlims can be [-540 540], by Christmas;
%
%==========================================================================
...
if isempty(New) && isfield(fgrid, 'poly_coast')
    ...
    if sum([xlim0 ylim0]==[0 1 0 1]) == 4
        ...
        elseif isequal(xlims,minmax(fgrid.LON))  && isequal(ylims,minmax(fgrid.LAT))  % default
            xlims = xlim0;
            ylims = ylim0;
        end
    end
...
%         gshhs_index = [fundir('w_2d_coast') 'data\gshhs_' Resolution '.i'];
    ...
    % ---> Christmas
    poly_coast = gshhs2(gshhs_path,ylims,xlims);
